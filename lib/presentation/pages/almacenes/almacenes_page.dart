...
class AlmacenesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // TODO: Conectar con BLoC de almacenes
    final almacenes = <Map<String, dynamic>>[];

    return Scaffold(
      appBar: AppBar(title: const Text('Almacenes')),
      body: almacenes.isEmpty
          ? Center(
              child: Column(
  ...
  void _mostrarFormularioAlmacen(
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    esEdicion ? 'Almacén actualizado' : 'Almacén creado',
                  ),
