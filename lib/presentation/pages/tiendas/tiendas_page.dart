                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              _buildEstadistica(
                                'Ventas del mes',
                                'Bs. ${(tienda['ventas_mes'] as double).toStringAsFixed(2)}',
                              ),
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    esEdicion ? 'Tienda actualizada' : 'Tienda creada',
                  ),
